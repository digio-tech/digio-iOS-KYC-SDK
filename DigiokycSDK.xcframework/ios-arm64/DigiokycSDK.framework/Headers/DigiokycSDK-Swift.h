...
+ (void)isCaptureKitAvailableWithCompletion:(void (^ _Nonnull)(BOOL))completion;
+ (void)launchCameraIfAvailableFrom:(UIViewController * _Nonnull)parent mode:(NSString * _Nonnull)mode isImagePreview:(BOOL)isImagePreview shouldShowSwitchCameraButton:(BOOL)shouldShowSwitchCameraButton completion:(void (^ _Nonnull)(NSString * _Nullable, UIImage * _Nullable, BOOL))completion onCancel:(void (^ _Nonnull)(void))onCancel;
+ (void)launchCameraIfAvailableFrom:(UIViewController * _Nonnull)parent mode:(NSString * _Nonnull)mode config:(CaptureConfig * _Nullable)config isImagePreview:(BOOL)isImagePreview shouldShowSwitchCameraButton:(BOOL)shouldShowSwitchCameraButton completion:(void (^ _Nonnull)(NSString * _Nullable, NSString * _Nullable, UIImage * _Nullable, CLLocation * _Nullable, CGRect, NSString * _Nullable, BOOL))completion onCancel:(void (^ _Nonnull)(NSString * _Nullable))onCancel onEvent:(void (^ _Nonnull)(NSString * _Nullable))onEvent;
